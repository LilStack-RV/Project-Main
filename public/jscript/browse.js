...
var popCardsInitial = function(cards){
  for(var i=0; i<cards.length; i++){
    ...
    + '<img src="' + cards[i].image + '" style="width:20px; height:20px;">' + '<p class="card-text">' + cards[i].features[0] + '</p>'
    ...
    + '<div class="card-footer text-right">' + '<a href="#" class="btn btn-primary ">Apply</a>' + '</div>'
    + '</div>'
    + '</div>'
    + '</div>');
    }else if(i<6){
